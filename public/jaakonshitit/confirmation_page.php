...
$_SESSION['comment'] = $_POST["comments"];
	...
	$sql = "INSERT INTO Grade (comment, field1, field2, field3, field4, field5, Person_personID, Thesis_thesisID) VALUES ('".$_SESSION['comment']."','".$_SESSION['grade1']."', '".$_SESSION['grade2']."','".$_SESSION['grade3']."', '".$_SESSION['grade4']."',  '".$_SESSION['grade5']."','".$_SESSION['person']."', '".$_SESSION['thesis']."')";
